            ...
            >
              <fieldset
                className={`border p-1 rounded w-full ${
                  errors.paragraph ? "border-red-500" : ""
                }`}
              >
                <legend
                  className={`px-1 mx-1 font-semibold ${
                    errors.paragraph ? "text-red-500" : ""
                  }`}
                >
                ...
                <textarea
                  ...
                  className={`w-full min-h-[120px] outline-none px-2 py-2 resize-y ${
                    errors.paragraph ? "border-red-500 text-red-500" : ""
                  }`}
                />
              </fieldset>
              <button
